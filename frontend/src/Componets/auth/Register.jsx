...
<label htmlFor="Lname" className='border-b text-gray-700 text-sm font-bold mb-2'>{t('Last Name')}</label>
              ...
              <small>By signing up, you agree to our <span className='text-blue-400'>Term and Conditions.
                ...
                Already registered? <span className='text-blue-400 cursor-pointer' onClick={showLogin}>{t('Login')}</span> 
</div>
          </div>
        </div>
      </div>
...
<span className='border-b- w-1/5 lg:w-1/4'></span>
 ...
 <div class="mt-4">
             ...
             <div className="mt-4 flex items-center justify-between">
<p className='text-sm'>{t('new to internarea? Register ')}(<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>{t('Student')}</span>/<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>company</span>) </p>
             </div>
</div>
                    </div>
                </div>
